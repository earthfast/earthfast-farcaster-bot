...
describe('parseUserMessage', () => {
    ...
    it('should throw error when !create is missing', () => {
        ...
        expect(() => parseUserMessage(message))
            .to.throw('Invalid message format. Expected: !create <token ticker> <token address> <escrow amount>');
    });
    ...
    it('should throw error when parameters are missing', () => {
        ...
        expect(() => parseUserMessage(message))
            .to.throw('Missing required parameters. Expected: !create <token ticker> <token address> <escrow amount>');
    });

    it('should handle message with extra text before !create', () => {
        const message = 'Hello world @EarthfastBot !create USDC 0x1234567890123456789012345678901234567890 1000';
        const result = parseUserMessage(message);
    ...
    it('should handle message with extra text after parameters', () => {
        const message = '@EarthfastBot !create USDC 0x1234567890123456789012345678901234567890 1000 please and thank you';
        const result = parseUserMessage(message);
