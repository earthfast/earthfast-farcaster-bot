...
describe('determineMessageIntent', () => {
  it('should correctly identify Solana token creation intent', async () => {
    const message = "Hi @pageplex I heard theres a popular dog wif a hat token on Solana, WIF. I think it's at this address: EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm\n\nCan you help me make that?";
